...
const container$7 = "_container_13zim_6 _disableSelect_mpqe1_1";
const decentFacet = "_decentFacet_13zim_14";
const appFacet = "_appFacet_13zim_21";
const appName = "_appName_13zim_31";
const appButtonArea = "_appButtonArea_13zim_44";
const appFacetSeparator = "_appFacetSeparator_13zim_50";
const contributorFacet = "_contributorFacet_13zim_57";
const favIcon = "_favIcon_13zim_68";
const settingsIcon = "_settingsIcon_13zim_75";
const styles$f = {
...
const contentButton = "_contentButton_rhsdb_6 _disableSelect_mpqe1_1";
const contentButtonText = "_contentButtonText_rhsdb_29";
const contentButtonDisabled = "_contentButtonDisabled_rhsdb_35 _contentButton_rhsdb_6 _disableSelect_mpqe1_1";
const contentButtonTextDisabled = "_contentButtonTextDisabled_rhsdb_45 _contentButtonText_rhsdb_29";
const styles$e = {
  contentButton,
  contentButtonText,
...
function ContentButton(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: buttonClass, onClick, disabled, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: textClass, children: text }) });
}
...
let theBasePath = null;
function parseBasePathFromUriPath(path) {
  const pathSegments = path.split("/").filter((segment) => segment !== "");
  if (pathSegments.length < 1) return "/";
  const appName2 = pathSegments[0];
  const isStagedApp = appName2.startsWith("_") && pathSegments.length > 1;
  return isStagedApp ? `/${appName2}/${pathSegments[1]}/` : `/${appName2}/`;
}
...
function ModalDialog(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: fullscreenOverlayStyle, onMouseDown: onCancel, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$d.dialog, onClick: _doNothing, onMouseDown: _doNothing, children: [
...
const MIMETYPE_PLAIN_TEXT = "text/plain";
...
var ModelDeviceProblemType = /* @__PURE__ */ ((ModelDeviceProblemType2) => {
...
const LOAD_SUCCESS_RATE_SAMPLE_COUNT = 4;
const LOAD_TIME_SAMPLE_COUNT = 4;
const INPUT_TOKENS_SAMPLE_COUNT = 20;
const OUTPUT_TOKENS_SAMPLE_COUNT = 20;
...
const LLM_CATEGORY_ID = "llm";
const LLM_SETTING_MAX_SIZE = "llmMaxSize";
const LLM_SETTING_AUTO_INC_MAX_SIZE = "autoIncMaxSize";
...
const WEBLLM_MEMORY_TO_STORAGE_RATIO = 3;
...
const AUTO_SELECT_ID = "auto-select";
const AUTO_SELECT_OPTION = {
  id: AUTO_SELECT_ID,
  originalIndex: -1,
...
const APP_CATEGORY_ID = "app-";
const APP_SETTINGS_LLM_ID = "llm";
...
var ToastState = /* @__PURE__ */ ((ToastState2) => {
...
const DEFAULT_WRITE_DELAY_MS = 3e3;
const DAY = 24 * 60 * 60 * 1e3;
const UNINITIALIZED_DAY_PATH = "UNINITIALIZED_DAY_PATH";
let theDayBuffer = [];
let theDayBufferPath = UNINITIALIZED_DAY_PATH;
let thePreviousDayPath = UNINITIALIZED_DAY_PATH;
let thePreviousDayEntryCount = 0;
let theDebouncedWriteTimer = null;
let theAppName = "";
let theLoggingSettings = null;
let theWriteDelayMs = DEFAULT_WRITE_DELAY_MS;
...
const LOGGING_CATEGORY_ID = "logging";
const LOGGING_SETTING_ENABLE = "enableLogging";
const LOGGING_SETTING_MAX_RETENTION_DAYS = "maxRetentionDays";
...
let theSetModalDialogName = null;
let theOpeningCategoryId = null;
...
const bar = "_bar_c4j8c_6";
const label$1 = "_label_c4j8c_13 _disableSelect_mpqe1_1";
const selectorButton = "_selectorButton_c4j8c_22 _disableSelect_mpqe1_1";
const tabButton = "_tabButton_c4j8c_34";
const firstSelectorButton = "_firstSelectorButton_c4j8c_50";
const lastSelectorButton = "_lastSelectorButton_c4j8c_55";
const selectorButtonText = "_selectorButtonText_c4j8c_60";
const selectorButtonSelected = "_selectorButtonSelected_c4j8c_68 _selectorButton_c4j8c_22 _disableSelect_mpqe1_1";
const icon$1 = "_icon_c4j8c_74";
const iconDisabled = "_iconDisabled_c4j8c_83 _icon_c4j8c_74";
const selectorButtonSelectedReclickable = "_selectorButtonSelectedReclickable_c4j8c_88 _selectorButton_c4j8c_22 _disableSelect_mpqe1_1";
const selectorButtonTextSelected = "_selectorButtonTextSelected_c4j8c_98 _selectorButtonText_c4j8c_60";
const selectorButtonDisabled = "_selectorButtonDisabled_c4j8c_103 _selectorButton_c4j8c_22 _disableSelect_mpqe1_1";
const selectorButtonTextDisabled = "_selectorButtonTextDisabled_c4j8c_116 _selectorButtonText_c4j8c_60";
const styles$c = {
  bar,
  label: label$1,
  selectorButton,
...
const container$6 = "_container_iv4ss_1";
const contentBox = "_contentBox_iv4ss_6";
const styles$b = {
...
const DEFAULT_DIRECTIONS = [Direction.ABOVE, Direction.BELOW, Direction.RIGHT, Direction.LEFT];
...
const POPOVER_HIDDEN_STYLE = { "visibility": "hidden" };
function Popover({ children, content, preferredDirection, allowedDirections }) {
  const [isOpen, setIsOpen] = useState(false);
  const [tryDirections, setTryDirections] = useState([]);
  ...
  const popoverContent = createPortal(/* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$b.contentBox, style: contentBoxStyle, ref: contentRef, onMouseOut: _onMouseOut, children: content }), document.body);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$b.container, ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onMouseOver: _onMouseOver, onMouseOut: _onMouseOut, children }),
    popoverContent
  ] });
}
function Selector({
  ...
  const options = optionNames.map((optionName, optionNo) => {
    ...
    const iconContent = iconChars && iconChars[optionNo] ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: iconClass, children: iconChars[optionNo] }) : null;
    const optionButtonContent = /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: buttonClass, onClick: () => _onOptionClick(optionNo), disabled, children: [
      iconContent,
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: textClass, children: optionName })
    ] }, optionName);
    return popoverContent ? /* @__PURE__ */ jsxRuntimeExports.jsx(Popover, { content: popoverContent[optionNo], preferredDirection: popoverPreferredDirection, allowedDirections: popoverAllowedDirections, children: optionButtonContent }, optionName) : optionButtonContent;
  });
  const labelElement = label2 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$c.label, children: [
    label2,
    ":"
  ] }) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$c.bar, children: [
    labelElement,
    options
  ] });
}
function SettingsCategorySelector({ categoryNames, selectedCategoryNo, onChange, disabled }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Selector, { optionNames: categoryNames, selectedOptionNo: selectedCategoryNo, onChange, disabled, displayAsTabs: true });
}
const container$5 = "_container_1dxqw_4";
const setterList = "_setterList_1dxqw_29";
const styles$a = {
  container: container$5,
  setterList
};
const container$4 = "_container_1vhj3_4";
const label = "_label_1vhj3_14";
const labelDisabled = "_labelDisabled_1vhj3_22 _label_1vhj3_14";
const heading = "_heading_1vhj3_27";
const headingDisabled = "_headingDisabled_1vhj3_37 _heading_1vhj3_27";
const validationMessage = "_validationMessage_1vhj3_61";
const styles$9 = {
...
const LAST_VALID_VALUE = "LAST_VALID_VALUE";
let theValidationMessageDelayMs = 3e3;
const theValidationMessageTimers = /* @__PURE__ */ new Map();
...
function BooleanToggleSetter({ setting, onChange, onValidateSetting, disabled }) {
  const [lastValidValue, setLastValidValue] = useState(setting.value);
  const [validationMessage2, setValidationMessage] = useState(null);
  ...
  const validationContent = validationMessage2 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$9.validationMessage, children: validationMessage2 }) : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$9.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: labelClass, children: setting.label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Selector, { optionNames, selectedOptionNo: setting.value ? 1 : 0, onChange: (optionNo) => _onChange(optionNo === 1), disabled }),
    validationContent
  ] });
}
...
function NumericInput({ minValue, maxValue, value, onChange, className, allowDecimals, digitWidth, disabled }) {
  ...
  const [digitWidthStyle, setDigitWidthStyle] = useState({});
  useEffect(() => {
...
const headingButton = "_headingButton_1gpxc_6 _disableSelect_mpqe1_1";
const headingButtonText = "_headingButtonText_1gpxc_29";
const headingButtonDisabled = "_headingButtonDisabled_1gpxc_35 _headingButton_1gpxc_6 _disableSelect_mpqe1_1";
const headingButtonTextDisabled = "_headingButtonTextDisabled_1gpxc_45 _headingButtonText_1gpxc_29";
const styles$8 = {
  headingButton,
  headingButtonText,
...
function _renderButtons(heading2, disabled) {
  ...
  return heading2.buttons.map((button) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HeadingButton, { text: button.label, onClick: () => heading2.onButtonClick?.(button.value), disabled }, button.value);
  });
}
function Heading({ heading: heading2, disabled }) {
  const buttonsContent = !heading2.buttons ? null : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$9.buttonsContainer, children: _renderButtons(heading2, disabled) });
  const headingClass = disabled ? styles$9.headingDisabled : styles$9.heading;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: headingClass, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: heading2.description }),
    buttonsContent
  ] });
}
const container$3 = "_container_t15oa_1";
const modelIdText$1 = "_modelIdText_t15oa_9";
const appBehaviorSummary = "_appBehaviorSummary_t15oa_20";
const speedContainer = "_speedContainer_t15oa_27";
const styles$7 = {
...
const container$2 = "_container_dabnx_1";
const progressBar = "_progressBar_dabnx_16";
const overTextBar = "_overTextBar_dabnx_24";
const inputSpeedBox = "_inputSpeedBox_dabnx_34 _speedBox_dabnx_5";
const outputSpeedBox = "_outputSpeedBox_dabnx_40 _speedBox_dabnx_5";
const styles$6 = {
...
const FRAMES_PER_SEC = 20, FRAME_INTERVAL = 1e3 / FRAMES_PER_SEC;
function LlmSpeed({ inputCharsPerSec, outputCharsPerSec }) {
  const [frameNo, setFrameNo] = useState(0);
  const [renderTiming] = useState(_calcRenderTiming(inputCharsPerSec, outputCharsPerSec));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.inputSpeedBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.outputSpeedBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: styles$6.progressBar,
...
const problemList = "_problemList_1a0tc_4";
const icon = "_icon_1a0tc_20";
const styles$5 = {
  problemList,
  icon
};
const InsufficientMemoryIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20d='M17,17H7V7H17M21,11V9H19V7C19,5.89%2018.1,5%2017,5H15V3H13V5H11V3H9V5H7C5.89,5%205,5.89%205,7V9H3V11H5V13H3V15H5V17A2,2%200%200,0%207,19H9V21H11V19H13V21H15V19H17A2,2%200%200,0%2019,17V15H21V13H19V11M13,13H11V11H13M15,9H9V15H15V9Z'%20/%3e%3c/svg%3e";
const InsufficientStorageIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20d='M12,3C7.58,3%204,4.79%204,7C4,9.21%207.58,11%2012,11C16.42,11%2020,9.21%2020,7C20,4.79%2016.42,3%2012,3M4,9V12C4,14.21%207.58,16%2012,16C16.42,16%2020,14.21%2020,12V9C20,11.21%2016.42,13%2012,13C7.58,13%204,11.21%204,9M4,14V17C4,19.21%207.58,21%2012,21C16.42,21%2020,19.21%2020,17V14C20,16.21%2016.42,18%2012,18C7.58,18%204,16.21%204,14Z'%20/%3e%3c/svg%3e";
const BadLoadSuccessIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20d='M13%2011H11V5H13M13%2015H11V13H13M20%202H4C2.9%202%202%202.9%202%204V22L6%2018H20C21.1%2018%2022%2017.1%2022%2016V4C22%202.9%2021.1%202%2020%202Z'%20/%3e%3c/svg%3e";
const BadPerformanceIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20d='M12%2016C13.66%2016%2015%2014.66%2015%2013C15%2011.88%2014.39%2010.9%2013.5%2010.39L3.79%204.77L9.32%2014.35C9.82%2015.33%2010.83%2016%2012%2016M12%203C10.19%203%208.5%203.5%207.03%204.32L9.13%205.53C10%205.19%2011%205%2012%205C16.42%205%2020%208.58%2020%2013C20%2015.21%2019.11%2017.21%2017.66%2018.65H17.65C17.26%2019.04%2017.26%2019.67%2017.65%2020.06C18.04%2020.45%2018.68%2020.45%2019.07%2020.07C20.88%2018.26%2022%2015.76%2022%2013C22%207.5%2017.5%203%2012%203M2%2013C2%2015.76%203.12%2018.26%204.93%2020.07C5.32%2020.45%205.95%2020.45%206.34%2020.06C6.73%2019.67%206.73%2019.04%206.34%2018.65C4.89%2017.2%204%2015.21%204%2013C4%2012%204.19%2011%204.54%2010.1L3.33%208C2.5%209.5%202%2011.18%202%2013Z'%20/%3e%3c/svg%3e";
const DeveloperIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20d='M8,3A2,2%200%200,0%206,5V9A2,2%200%200,1%204,11H3V13H4A2,2%200%200,1%206,15V19A2,2%200%200,0%208,21H10V19H8V14A2,2%200%200,0%206,12A2,2%200%200,0%208,10V5H10V3M16,3A2,2%200%200,1%2018,5V9A2,2%200%200,0%2020,11H21V13H20A2,2%200%200,0%2018,15V19A2,2%200%200,1%2016,21H14V19H16V14A2,2%200%200,1%2018,12A2,2%200%200,1%2016,10V5H14V3H16Z'%20/%3e%3c/svg%3e";
const BetaIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2024%2024'%3e%3cpath%20d='M9.23,17.59V23.12H6.88V6.72C6.88,5.27%207.31,4.13%208.16,3.28C9,2.43%2010.17,2%2011.61,2C13,2%2014.07,2.34%2014.87,3C15.66,3.68%2016.05,4.62%2016.05,5.81C16.05,6.63%2015.79,7.4%2015.27,8.11C14.75,8.82%2014.08,9.31%2013.25,9.58V9.62C14.5,9.82%2015.47,10.27%2016.13,11C16.79,11.71%2017.12,12.62%2017.12,13.74C17.12,15.06%2016.66,16.14%2015.75,16.97C14.83,17.8%2013.63,18.21%2012.13,18.21C11.07,18.21%2010.1,18%209.23,17.59M10.72,10.75V8.83C11.59,8.72%2012.3,8.4%2012.87,7.86C13.43,7.31%2013.71,6.7%2013.71,6C13.71,4.62%2013,3.92%2011.6,3.92C10.84,3.92%2010.25,4.16%209.84,4.65C9.43,5.14%209.23,5.82%209.23,6.71V15.5C10.14,16.03%2011.03,16.29%2011.89,16.29C12.73,16.29%2013.39,16.07%2013.86,15.64C14.33,15.2%2014.56,14.58%2014.56,13.79C14.56,12%2013.28,11%2010.72,10.75Z'%20/%3e%3c/svg%3e";
function _renderProblemIcon(problemType) {
  switch (problemType) {
    case ModelDeviceProblemType.INSUFFICIENT_VRAM:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: InsufficientMemoryIcon, alt: "Insufficient VRAM" });
    case ModelDeviceProblemType.INSUFFICIENT_STORAGE:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: InsufficientStorageIcon, alt: "Insufficient Storage" });
    case ModelDeviceProblemType.BAD_LOAD_SUCCESS_HISTORY:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: BadLoadSuccessIcon, alt: "Bad Load Success History" });
    case ModelDeviceProblemType.BAD_PERFORMANCE_HISTORY:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: BadPerformanceIcon, alt: "Bad Performance History" });
    case ModelDeviceProblemType.WEBGPU_NOT_AVAILABLE:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: InsufficientMemoryIcon, alt: "WebGPU Not Available" });
    case ModelDeviceProblemType.DEVELOPER_MODE:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: DeveloperIcon, alt: "Developer Mode" });
    case ModelDeviceProblemType.BETA:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$5.icon, src: BetaIcon, alt: "Beta" });
    default:
      botch();
  }
}
function ModelDeviceProblemsList({ problems }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: styles$5.problemList, children: problemsContent });
}
function SupportedModelPopoverContent({ modelId, appBehaviorSummary: appBehaviorSummary2, problems, inputCharsPerSec, outputCharsPerSec }) {
  const speedContent = inputCharsPerSec > 0 || outputCharsPerSec > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.speedContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LlmSpeed, { inputCharsPerSec, outputCharsPerSec }) }) : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.modelIdText, children: modelIdContent }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$7.appBehaviorSummary, children: appBehaviorSummary2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModelDeviceProblemsList, { problems }),
    speedContent
  ] });
}
function _renderPopoverContent(modelOptions) {
  return modelOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function SupportedModelSetter({ setting, onChange, onValidateSetting, disabled }) {
  ...
  const content = availableModelCount === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "LLM is not used by app." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
    Selector,
    {
...
function _renderSetters(category, validities, setValidities, onChange, onValidateSetting) {
  ...
  if (!setterRows.length) return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No settings are available." });
  ...
  return setterRows.map((settingRow, settingRowNo) => {
    ...
    switch (settingRow.type) {
      ...
      case HEADING_TYPE:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Heading, { heading: settingRow }, `heading@${settingRowNo}`);
      default:
...
function SettingCategoryPanel({ category, onValidateSetting, onChange, isOpen }) {
  const [validities, setValidities] = useState(Array(category.settings.length).fill(true));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$a.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: category.description }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$a.setterList, children: settersContent })
  ] });
}
const container$1 = "_container_1ldt5_1";
const styles$4 = {
  container: container$1
};
function DialogFooter(props) {
  const { children } = props;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.container, children });
}
const dialogButton = "_dialogButton_1e5oo_6 _disableSelect_mpqe1_1";
const dialogButtonText = "_dialogButtonText_1e5oo_28";
const dialogButtonDisabled = "_dialogButtonDisabled_1e5oo_34 _dialogButton_1e5oo_6 _disableSelect_mpqe1_1";
const dialogButtonTextDisabled = "_dialogButtonTextDisabled_1e5oo_44 _dialogButtonText_1e5oo_28";
const dialogButtonPrimary = "_dialogButtonPrimary_1e5oo_49 _dialogButton_1e5oo_6 _disableSelect_mpqe1_1";
const styles$3 = {
  dialogButton,
  dialogButtonText,
...
function PageRefreshConfirmDialog(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalDialog, { isOpen, title: "LLM Changed", onCancel, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Would you like to reload the app to use the new LLM that you chose?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Not Now", onClick: onCancel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Refresh Page", onClick: onConfirm, isPrimary: true })
    ] })
  ] });
}
function SettingsDialog({ isOpen, defaultAppSettings, onClose, onLoadAppSettings, onSaveAppSettings, onValidateSetting }) {
  const initialAppSettingsRef = useRef(defaultAppSettings);
  const [categories, setCategories] = useState([]);
  const [selectedCategoryNo, setSelectedCategoryNo] = useState(0);
  const [categoryValidities, setCategoryValidities] = useState(Array(categories.length).fill(true));
  const [showRefreshDialog, setShowRefreshDialog] = useState(false);
  const [initialLlmValue, setInitialLlmValue] = useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalDialog, { title: "Device Settings", isOpen, onCancel: () => onClose(categories[0].settings), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      categories.map((category, categoryNo) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Cancel", onClick: onClose }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Save and Exit", onClick: _handleSaveAndClose, isPrimary: true, disabled: isSaveDisabled })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const container = "_container_hyytp_4 _disableSelect_mpqe1_1";
const styles$2 = {
  container
};
const containerError = "_containerError_10gzw_26 _container_10gzw_3";
const containerInfo = "_containerInfo_10gzw_31 _container_10gzw_3";
const containerImportant = "_containerImportant_10gzw_36 _container_10gzw_3";
const containerAppear = "_containerAppear_10gzw_51";
const containerDisappear = "_containerDisappear_10gzw_56";
const dismissIcon = "_dismissIcon_10gzw_61";
const styles$1 = {
  containerError,
  containerInfo,
  containerImportant,
...
function ToastMessage(props) {
  ...
  const dismissIcon2 = showDismissIcon ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.dismissIcon, onClick: onDismiss, children: "✖" }) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: containerStyle, onClick: onDismiss, children: [
...
const APPEAR_DURATION_MSECS = 1e3;
const MESSAGE_DURATION_MSECS = 5e3;
const DISAPPEAR_DURATION_MSECS = 1e3;
...
function ToastPane() {
  ...
  const renderedToasts = toastsRef.current.map((toast) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToastMessage, { toast, toastState: toast.state, onDismiss: () => _dismissToast(toast.id, toastsRef) }, toast.id));
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.container, children: renderedToasts });
}
...
function _appLinksContent(links, onClickLink) {
  if (!links.length) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: " " });
  const linkButtons = links.map((link, buttonNo) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ContentButton, { text: link.description, onClick: () => {
      onClickLink(link);
    } }, buttonNo);
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function DecentBar({
  ...
  const initialAppSettings = useRef(defaultAppSettings || _createDefaultAppSettings(appName2));
  const [favIconUrl, setFavIconUrl] = useState(null);
  const [modalDialogName, setModalDialogName] = useState(null);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: containerClassName, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: decentFacetClassName, children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: homeUrl, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: favIconUrl, className: favIconClassName, draggable: "false" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: appFacetClassName, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: appNameClassName, children: appName2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: appButtonAreaClassName, children: appLinksContent })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: appFacetSeparatorClassName }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: contributorFacetClassName, children: [
        contributorText,
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: SettingsIcon, className: settingsIconClassName, alt: "Device Settings", onClick: () => setModalDialogName(SettingsDialog.name) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SettingsDialog,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToastPane, {})
  ] });
}
const continueText = "_continueText_rt9ep_4";
const modelIdText = "_modelIdText_rt9ep_8";
const problemPanel = "_problemPanel_rt9ep_16";
const styles = {
  continueText,
  modelIdText,
  problemPanel
...
function _renderFooterButtons(hasBlockingProblem, otherModelCount, onCancel, onConfirm) {
  ...
  if (otherModelCount > 0) {
    buttons.push(
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Other Models", onClick: () => {
        onCancel();
  ...
  buttons.push(
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Cancel", onClick: onCancel, isPrimary: hasBlockingProblem }, "cancel")
  );
  if (!hasBlockingProblem) {
    buttons.push(
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogButton, { text: "Load Model", onClick: onConfirm, isPrimary: true }, "loadModel")
    );
  }
  return buttons;
}
function ModelDeviceProblemsDialog({ isOpen, problems, onConfirm, onCancel, modelId, supportedModels }) {
  const [otherModelCount, setOtherModelCount] = useState(null);
  useEffect(() => {
  ...
  const summaryContent = isDeveloperMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
    "Development environment detected. Paused loading ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.modelIdText, children: modelId }),
    " until you confirm."
  ] }) : problems.length === 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalDialog, { isOpen, title: hasBlockingProblem ? "Failed to Load Model" : "Continue Loading Model?", onCancel, children: [
    summaryContent,
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.problemPanel, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModelDeviceProblemsList, { problems }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles.continueText, children: conclusionMessage }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: footerButtons })
  ] });
}
export {
  APP_CATEGORY_ID,
